      ...
      <section className="overflow-hidden">
        <div className="relative mx-auto max-w-5xl px-6 pt-28 lg:pt-24">
          <div className="relative z-10 mx-auto max-w-2xl text-center">
            <h1 className="text-balance text-4xl font-geist font-semibold md:text-5xl lg:text-6xl">
              Where Modern Learning Begins.
            </h1>
            <p className="text-muted-foreground mx-auto my-8 max-w-2xl text-xl">
              A modern platform built for clear learning, real growth, and
              simple course discovery, helping you move forward with confidence
              and focus.
            </p>
