    ...
    <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] mt-5 gap-10 mb-24">
      <div>
        <div className="aspect-video w-full overflow-hidden rounded-lg shadow-lg bg-accent/40 relative">
          ...
          <div className="absolute bottom-4 right-4 bg-black/80 px-3 py-0.5 rounded-2xl text-md">
            {formatDuration(course.duration)}
          </div>
        </div>
        <div className="mt-6 px-1 space-y-1">
          <h1 className="capitalize text-xl md:text-2xl font-medium">
            {course.title}
          </h1>
